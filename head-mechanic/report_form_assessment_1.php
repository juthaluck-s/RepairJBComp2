...
$queryCaseAsm1 = $condb->prepare("SELECT *
                                  FROM tbl_case AS c
                                  ...
                                  LEFT JOIN tbl_building AS bd ON c.ref_building_id = bd.building_id  WHERE c.ref_status_id IN (4) AND asm.assessment_id = 1
                                                                ");

$queryCaseAsm1->execute();
$rsCaseAsm1 = $queryCaseAsm1->fetchAll();
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>รายงานการแจ้งซ่อมที่ได้ผลประเมินดีมาก</h1>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
