...
INNER JOIN tbl_position AS pst ON m.ref_position_id = pst.position_id
                                            WHERE m_level = 'mechanic'";
                                            $result = $condb->query($querySelectMechanic);
                                            ?>

                                            <form method="post" action="assign_db.php?id=<?= $case_id; ?>"
                                                ...
                                                <table class="table table-bordered table-striped">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?= $row['firstname'] . ' ' . $row['lastname']; ?><br>
                                                            ...
                                                            <br> แผนก : <?= $row['department_name']; ?>
                                                            <br> ตำแหน่ง : <?= $row['position_name']; ?>
                                                        </td>
                                                    ...
                                                    <?php
                                                        ...
                                                        echo "<tr><td colspan='4'>ไม่มีข้อมูลช่างที่เป็น mechanic</td></tr>";
                                                    }
                                                    ?>
