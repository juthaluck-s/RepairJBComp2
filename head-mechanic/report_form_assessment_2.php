...
$queryCaseAsm2 = $condb->prepare("SELECT *
                                  FROM tbl_case AS c
                                  ...
                                  LEFT JOIN tbl_building AS bd ON c.ref_building_id = bd.building_id  WHERE c.ref_status_id IN (4) AND asm.assessment_id = 2
                                                                ");

$queryCaseAsm2->execute();
$rsCaseAsm2 = $queryCaseAsm2->fetchAll();
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>รายงานการแจ้งซ่อมที่ได้ผลประเมินดี</h1>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="center" style=" vertical-align: middle;">
                                                            <a href="case.php?id=<?= $row['case_id']; ?>&act=view&no=<?= $i - 1; ?>"
                                                                class="btn-edit5 btn-success btn-sm">Open</a>
                                                        </td>
                                                    </tr>
                                                    <?php } ?>
