...
$queryCaseAsm5 = $condb->prepare("SELECT *
                                  FROM tbl_case AS c
                                  ...
                                  LEFT JOIN tbl_building AS bd ON c.ref_building_id = bd.building_id  WHERE c.ref_status_id IN (4) AND asm.assessment_id = 5
                                                                ");

$queryCaseAsm5->execute();
$rsCaseAsm5 = $queryCaseAsm5->fetchAll();
