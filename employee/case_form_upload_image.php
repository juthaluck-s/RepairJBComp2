                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <button type="submit" name="btn" value="upload"
                                                class="btn btn-primary">อัปโหลดไฟล์ภาพ</button>
                            ...
                            <table class="table table-bordered table-hover table-striped table-sm">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="../assets/product_gallery/<?= $row['product_image']; ?>"
                                                width="100px">
                                        </td>
...
if (isset($_POST['id']) && isset($_POST['no']) && isset($_POST['product_image']) && isset($_POST['act']) && $_POST['act'] == 'deleteImg') {
        ...
        echo '<script>
             setTimeout(function() {
              swal({
                  ...
                  window.location = "product.php?id=' . $id . '&act=image";
              });
            }, 1000);
        </script>';
        exit();
