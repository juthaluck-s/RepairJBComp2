...
if (isset($_POST['m_id']) && isset($_POST['NewPassword']) && isset($_POST['ConfirmPassword'])) {
    ...
    try {
        ...
        window.location = "member.php?m_id=' . $m_id . '&act=editPwd"; //หน้าที่ต้องการให้กระโดดไป
        });
        }, 1000);
        </script>';
        } else {
            ...
            //sql update
            $stmtUpdate = $condb->prepare("UPDATE  tbl_member SET password='$password' WHERE m_id=:m_id");
